...
namespace Firestore.Typed.Client
{
    ...
    {
        public Query Untyped { get; }

        internal TypedQuery(Query untyped)
        {
            Untyped = untyped;
        }
        ...
        /// </summary>
        public virtual FirestoreDb Database => Untyped.Database;
        ...
        {
            return new TypedQuery<TDocument>(Untyped.Select(fields.GetFieldNames()));
        }

        public async Task<TypedQuerySnapshot<TDocument>> GetSnapshotAsync(CancellationToken cancellationToken = default)
        {
            QuerySnapshot? querySnapshot = await Untyped.GetSnapshotAsync(cancellationToken).ConfigureAwait(false);
        ...
        {
            return new TypedQuery<TDocument>(Untyped.WhereEqualTo(field.GetFieldName(), value));
        }
        ...
        {
            return new TypedQuery<TDocument>(Untyped.WhereNotEqualTo(field.GetFieldName(), value));
        }
        ...
        {
            return new TypedQuery<TDocument>(Untyped.WhereLessThan(field.GetFieldName(), value));
        }
        ...
        public TypedQuery<TDocument> WhereLessThanOrEqualTo<TField>(
            ...
            TField value)
        {
            return new TypedQuery<TDocument>(Untyped.WhereLessThanOrEqualTo(field.GetFieldName(), value));
        }
        ...
        {
            return new TypedQuery<TDocument>(Untyped.WhereGreaterThan(field.GetFieldName(), value));
        }
        ...
        public TypedQuery<TDocument> WhereGreaterThanOrEqualTo<TField>(
            ...
            TField value)
        {
            return new TypedQuery<TDocument>(Untyped.WhereGreaterThanOrEqualTo(field.GetFieldName(), value));
        }
        ...
        public TypedQuery<TDocument> WhereArrayContains<TField>(
            ...
            TField value)
        {
            return new TypedQuery<TDocument>(Untyped.WhereArrayContains(field.GetFieldName(), value));
        }
        ...
        {
            return new TypedQuery<TDocument>(Untyped.WhereArrayContainsAny(field.GetFieldName(), values));
        }
        ...
        public TypedQuery<TDocument> WhereIn<TField>(
            ...
            IEnumerable<TField> values)
        {
            return new TypedQuery<TDocument>(Untyped.WhereIn(field.GetFieldName(), values));
        }
        ...
        public TypedQuery<TDocument> WhereNotIn<TField>(
            ...
            IEnumerable<TField> values)
        {
            return new TypedQuery<TDocument>(Untyped.WhereNotIn(field.GetFieldName(), values));
        }
        ...
        {
            return new TypedQuery<TDocument>(Untyped.OrderBy(field.GetFieldName()));
        }
        ...
        {
            return new TypedQuery<TDocument>(Untyped.OrderByDescending(field.GetFieldName()));
        }
        ...
        {
            return new TypedQuery<TDocument>(Untyped.Limit(limit));
        }
        ...
        {
            return new TypedQuery<TDocument>(Untyped.LimitToLast(limit));
        }
        ...
        {
            return new TypedQuery<TDocument>(Untyped.Offset(offset));
        }
        ...
        {
            return new TypedQuery<TDocument>(Untyped.StartAt(fieldValues));
        }
        ...
        {
            return new TypedQuery<TDocument>(Untyped.StartAfter(fieldValues));
        }
        ...
        {
            return new TypedQuery<TDocument>(Untyped.EndBefore(fieldValues));
        }
        ...
        {
            return new TypedQuery<TDocument>(Untyped.EndAt(fieldValues));
        }
        ...
        {
            return new TypedQuery<TDocument>(Untyped.StartAt(snapshot.Untyped));
        }
        ...
        {
            return new TypedQuery<TDocument>(Untyped.StartAfter(snapshot.Untyped));
        }
        ...
        {
            return new TypedQuery<TDocument>(Untyped.EndBefore(snapshot.Untyped));
        }
        ...
        {
            return new TypedQuery<TDocument>(Untyped.EndAt(snapshot.Untyped));
        }
        ...
        {
            await foreach (DocumentSnapshot snapshot in Untyped.StreamAsync(cancellationToken).ConfigureAwait(false))
            {
