...
/// </summary>
public sealed class TypedDocumentSnapshot<TDocument>(DocumentSnapshot untyped, TypedDocumentReference<TDocument> reference)
    : IEquatable<TypedDocumentSnapshot<TDocument>>
{
    ...
    public DocumentSnapshot Untyped { get; } = untyped;
    ...
    /// </summary>
    public TypedDocumentReference<TDocument> Reference { get; } = reference;
